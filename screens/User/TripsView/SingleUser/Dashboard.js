...
const Dashboard = props => {
  ...
  const getTrip = useSelector(
    state => state.firestore.data.userTrips[selectedTrip]
  );
  ...
  const currentFormTotal = () => {
    const currentTotal =
      parseInt(airfareText) +
      parseInt(transportationText) +
      parseInt(lodgingText) +
      parseInt(foodText) +
      parseInt(activitiesText) +
      parseInt(emergencyText) +
      parseInt(miscText);
    ...
    getTrip.totalBudget === currentTotal
      ? setTextColor("green")
      : console.log(setTextColor("red"));
  };
  ...
  const BudgetFormInstructions = press => {
    Alert.alert(
      ...
      [{ text: "Ok", onPress: () => console.log("Ok Pressed, Alert Closed") }]
    );
  };
                  ...
                  <View style={styles.overlayView}>
                    ...
                    <View style={styles.overlayBody}>
                      <Text style={styles.overlayText}>
                        You created a trip, let's keep going and help you track
                        your progress.
                      </Text>
                      <Text style={styles.overlayText}>
                      ...
                      <Text style={styles.overlayText}>
                        The next form will help us do just that! Make sure to
                        match your Category Budget to your Total Budget.
                      </Text>
                      <Text style={styles.overlayText}>
                        Hint: Take advantage of the calculate button to help
                        match your budgets.
                      </Text>
                    </View>
  ...
  if (
    isLoaded(
      BudgetData && <BudgetBreakdownChart /> && <ImageBackground /> &&
        UserProfile
    )
  ) {
    return (
          ...
          <View style={styles.screen}>
            ...
            >
              <View style={styles.overlayView}>
                ...
                <View style={styles.overlayBody}>
                  <Text style={styles.overlayText}>
                    The purpose of this screen is to help you understand how
                    you've decided to allocate your budget.
                  </Text>
                  <Text style={styles.overlayText}>
                    Need more info? Try pressing the charts to better understand
                    their meaning!
                  </Text>
                  <Text style={styles.overlayText}>
                    Or, press the info button to get a more detailed breakdown
