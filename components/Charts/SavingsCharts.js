...
const SavingsCharts = () => {
  ...
  const fullStoreSavingsArr = useSelector(
    state => state.firestore.ordered[SavingsData]
  );
  const EmergencySavingsArr = useSelector(
    state => state.firestore.ordered[EmergencySavings]
  );
  const MiscSavingsArr = useSelector(
    state => state.firestore.ordered[MiscSavings]
  );
  const ActivitiesSavingsArr = useSelector(
    state => state.firestore.ordered[ActivitiesSavings]
  );
  const TransportationSavingsArr = useSelector(
    state => state.firestore.ordered[TransportationSavings]
  );
  const FoodSavingsArr = useSelector(
    state => state.firestore.ordered[FoodSavings]
  );
  const LodgingSavingsArr = useSelector(
    state => state.firestore.ordered[LodgingSavings]
  );
  const AirfareSavingsArr = useSelector(
    state => state.firestore.ordered[AirfareSavings]
  );
              ...
              popover={
                <View style={styles.tooltipTextContainer}>
                  ...
                  <Text style={styles.toolTipText}>
                    You've saved: ${item[2].currentTotal}
                  </Text>
                  {item[2].Nobudget ? (
